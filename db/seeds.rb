...
user1 = User.create!(email: 'user1@test.com',
  ...
  photo_url: 'http://www.zealoptics.com/media//anton_Krupicka_small.jpg'
)
...
blog2 = user1.blogs.create!(title: "Trails",
  body: "Real runners run trails. If you're not muddy after a run then what's the point?",
  preview: "Trail running is the best."
)
blog3 = user2.blogs.create!(title: "Road Running",
  body: "I love flat roads. Trails and hills are dumb. Road racing is where the action is.",
  preview: "I heart asphalt."
)

shoe1 = user1.shoes.create!(name: "NB980v1 Black/Green",
  distance: 0
)
shoe2 = user1.shoes.create!(name: "NB Zante NYC",
  distance: 0
)
shoe3 = user1.shoes.create!(name: "Asics Fuji Race v1 Purple",
  distance: 0,
)
shoe4 = user2.shoes.create!(name: "Hoka Conquestv1 Blue",
  distance: 0
)

log1 = user1.logs.create!(title: "Tempo Run",
...
log3 = user1.logs.create!(title: "Hill Repeats",
...
log4 = user1.logs.create!(title: "Long Trail Run",
...
log6 = user2.logs.create!(title: "Long Run",
  date: Date.new(2014, 8, 6),
  distance: 17.3,
...
log7 = user2.logs.create!(title: "Fartlek",
  date: Date.new(2014, 8, 8),
  distance: 10.3,
  duration: (73 * 60),
...
log8 = user2.logs.create!(title: "Easy Run",
  date: Date.new(2014, 8, 10),
  distance: 4.5,
  duration: (4.5 * 7.4 * 60),
